...
export type GetTotalPullRequestsQueryVariables = Exact<{
  name: Scalars['String'];
  owner: Scalars['String'];
}>;


export type GetTotalPullRequestsQuery = (
  { __typename?: 'Query' }
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & { pullRequests: (
...
export const GetTotalPullRequestsDocument = gql`
    query getTotalPullRequests($name: String!, $owner: String!) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getTotalPullRequests(variables: GetTotalPullRequestsQueryVariables): Promise<{ data?: GetTotalPullRequestsQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetTotalPullRequestsQuery>(print(GetTotalPullRequestsDocument), variables));
    }
  };
}
